...
(function (factory) {
    ...
    $.Detect = function (url, callback) {
        detect(autoBuildUrl(url), callback);
    }
        ;
     ...
     */
    function sso(url, params, callback) {
        $.get(autoBuildUrl(url) + "/v1/srun_portal_sso" + params, callback);
    }

    /*
     * SSO Auth
     */
    $.SSO = function (url, data, callback) {
